...
use Motomedialab\Bunny\Integrations\Requests\FetchVideoUrlRequest;
...
describe('upload video tests', function () {
    ...
    it('can upload a video using fetch', function  () {
        ...
        $request = new FetchVideoUrlRequest(config('bunny-stream.video_library_id'), 'https://google.co.uk', 'A test title');
